...
// this rule — used by registration, password reset, and the login/password-reset rate limiters,
// so the same normalized string is always used as both the DB key and the rate-limit bucket key.
